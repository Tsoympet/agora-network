...
now includes a versioned Borsh manifest (v4 preserves the v2 chain/network
binding and adds ceremony-selected validator commission/metadata plus explicit
disabled-by-default DA activation and TLT fees), a lossless Meta envelope, and fail-closed overlay verification
