...
pub struct ConsensusLimits {
    ...
    /// Aggregate Borsh bytes of authenticated DA authorizations.
    pub max_data_commitment_bytes: usize,
...
impl Default for ConsensusLimits {
    fn default() -> Self {
        Self {
            ...
            max_data_commitment_bytes: 1_000_000,
...
pub const MAX_DATA_COMMITMENT_BYTES_PER_BLOCK: usize = 1_000_000;
